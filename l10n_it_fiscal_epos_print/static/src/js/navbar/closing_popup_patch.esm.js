...
/**
 * Extend the ClosePosPopup to execute fiscal Z closure when closing session
 */
const FiscalClosePosPopup = (ClosePosPopup) =>
    class extends ClosePosPopup {
        ...
        async executeFiscalZClosure() {
            ...
            try {
                ...
                const printerUrl = `${protocol}${this.env.pos.config.printer_ip}/cgi-bin/fpmate.cgi`;
